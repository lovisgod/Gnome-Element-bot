    ...
    getSafeAccountData(eventType, defaultContent = null) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                LogService_1.LogService.warn("MatrixClient", `Error getting ${eventType} account data:`, e);
    ...
    getSafeRoomAccountData(eventType, roomId, defaultContent = null) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                LogService_1.LogService.warn("MatrixClient", `Error getting ${eventType} room account data in ${roomId}:`, e);
                return defaultContent;
            }
        });
    }
